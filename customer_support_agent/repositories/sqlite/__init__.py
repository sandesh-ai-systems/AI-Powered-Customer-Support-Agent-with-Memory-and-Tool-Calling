### This file is Dashboard buttons to control all engines
...
#Customer Functions , Wraps customer.py
...
## Ticket Functions , Wraps tickets.py
def create_ticket(
    customer_id: int,
    subject: str,
    description: str,
...
## Draft Functions , Wraps drafts.py
