## Repository layer for managing support tickets (core business entity)
...
class TicketsRepository:
  ...
  ## Get All Tickets
    def list(self, limit: int = 100) -> list[dict[str, Any]]:
        with connect() as conn:
            rows = conn.execute(  ### Ticket + Customer info in one query
                """
                SELECT
                    t.*,
 ...
 ### open → in_progress → resolved   
  ...
  ### count of Customer's total open tickets 
...
### Full System Flow (Now Everything Connects)

# Step 1: Create Customer
# Step 2: Create Ticket
# Step 3: Generate Draft
# Step 4: Agent Reviews Draft
# Step 5: Accept Draft
# Step 6: Store Memory